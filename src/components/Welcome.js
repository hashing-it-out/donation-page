...
class Welcome extends Component {
    render() {
        return <div>
            <h1>Donate to Hashing It Out Podcast</h1>
            <h4>
            {`Welcome to the Hashing It Out Podcast Donation Page.  We do this as a hobby and appreciate any 
            ...
            Hashing It Out and The Bitcoin Podcast Network grow! `}
            </h4>
        </div>
    }
}
